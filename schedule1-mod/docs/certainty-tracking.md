...
| S1API mints NPCs by cloning a SpawnablePrefabs base (BaseEmployee here), normalizing inactive, AddObject-registering, then network-spawning | cited | S1API source read (Entities/NPC.cs GetOrCreatePerNpcPrefab, AddObject at line 1131), clone in session scratchpad 2026-08-08 | drive it live via our shim (next session) |
