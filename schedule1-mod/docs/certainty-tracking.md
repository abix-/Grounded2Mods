...
| 135 NPC instances live; NPCManager keeps static NPCRegistry: List<NPC> + static GetNPC | proven | walk_class census + list_methods 2026-08-07 | registry not yet walked; spawn path unknown |
