...
pub static FIELDS: &[FieldDef] = &[
    FieldDef {
        name: "ShiningsTimer",
        desc: "Minutes per emission cycle",
        offset: 0x00,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "DayLength",
        desc: "Duration of daytime in minutes",
        offset: 0x08,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "NightLength",
        desc: "Duration of nighttime in minutes",
        offset: 0x10,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "WeatherCycleDuration",
        desc: "How long each weather cycle lasts",
        offset: 0x18,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "InitialSeason",
        desc: "Starting season index",
        offset: 0x20,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "HungerSpeed",
        desc: "How fast hunger drains (higher = faster)",
        offset: 0x28,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "ThirstSpeed",
        desc: "How fast thirst drains (higher = faster)",
        offset: 0x30,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "StaminaDrainRate",
        desc: "How fast stamina depletes (higher = faster)",
        offset: 0x38,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "HeadshotDamageMultiplier",
        desc: "Damage multiplier for headshots",
        offset: 0x40,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "DamageMultiplier",
        desc: "Global player damage output multiplier",
        offset: 0x48,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "ItemsDurabilityDamageMultiplier",
        desc: "How fast items lose durability",
        offset: 0x50,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "AnomaliesDamageToPlayer",
        desc: "Damage anomalies deal to the player",
        offset: 0x58,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "AnomaliesSpawnRate",
        desc: "How often anomalies spawn (higher = more)",
        offset: 0x60,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "EnemySpawnRate",
        desc: "How often enemies spawn (higher = more)",
        offset: 0x68,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "EnemyDamageToPlayer",
        desc: "Damage enemies deal to the player",
        offset: 0x70,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "EnemySpeed",
        desc: "Enemy movement speed multiplier",
        offset: 0x78,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "RadiationPower",
        desc: "Radiation zone strength",
        offset: 0x80,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "InsanityPower",
        desc: "Insanity buildup rate",
        offset: 0x88,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "AmmoScarcity",
        desc: "Ammo spawn rarity (higher = less ammo)",
        offset: 0x90,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "FoodScarcity",
        desc: "Food spawn rarity (higher = less food)",
        offset: 0x98,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "HealsScarcity",
        desc: "Healing item rarity (higher = fewer heals)",
        offset: 0xA0,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "RespawnHealthMultiplier",
        desc: "Health fraction after respawning (1.0 = full)",
        offset: 0xA8,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "WeightLimitMultiplier",
        desc: "Carry weight limit multiplier (higher = carry more)",
        offset: 0xB0,
        ty: FieldType::Double,
    },
    FieldDef {
        name: "FriendlyFire",
        desc: "Players can damage each other",
        offset: 0xB8,
        ty: FieldType::Bool,
    },
    FieldDef {
        name: "Shitting",
        desc: "Defecation mechanic enabled",
        offset: 0xB9,
        ty: FieldType::Bool,
    },
    FieldDef {
        name: "Permadeath",
        desc: "Death is permanent (no respawn)",
        offset: 0xBA,
        ty: FieldType::Bool,
    },
    FieldDef {
        name: "RespawnOnEmission",
        desc: "Player respawns when an emission hits",
        offset: 0xBB,
        ty: FieldType::Bool,
    },
    FieldDef {
        name: "CollisionBetweenPlayers",
        desc: "Players physically collide with each other",
        offset: 0xBC,
        ty: FieldType::Bool,
    },
];
