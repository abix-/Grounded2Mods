...
local OverworldSeedbotBaseSpawnChance = 30
local OverworldSeedbotPerTierSpawnChance = 15
local OverworldSeedbotMaxSpawnChance = 90

local OverworldHaybotInFieldSpawnChance = 45
