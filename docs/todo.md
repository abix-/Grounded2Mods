...
| 3 | `unityforge` | [ ] Move find_instances (rename from walk), first_handle, handle_of, count_of, dump_sequence from schedule1-mod and wwm-mod tests/common into unityforge::client as generic Unity research helpers | schedule1-mod and wwm-mod tests/common use unityforge::client:: for all instance-finding and handle helpers. |
| 3 | `unityforge` | [ ] Move print_declared_methods from schedule1-mod and wwm-mod tests/common into unityforge::client | Both mods use unityforge::client::print_declared_methods. |
| 3 | `unityforge` | [ ] Move field_exists and fields from wwm-mod tests/common into unityforge::client | wwm-mod tests/common uses unityforge::client:: for field inspection. |
| 3 | `unityforge` | [ ] Move parse_vec3 from schedule1-mod tests/common into unityforge::client | schedule1-mod tests/common uses unityforge::client::parse_vec3. |
| 3 | `modforge` | [ ] Move ping_or_skip pattern from schedule1-mod, wwm-mod, misery-mod tests/common into modforge::client as a generic skip-if-no-game helper | All mods use modforge::client:: for the ping-or-skip pattern. |
