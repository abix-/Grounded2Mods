...
5. Storyteller / director
6. The horde (adaptive pressure) = the storyteller's Mario Kart layer
7. The act repertoire
8. Faction personality / evolution
9. AI-vs-AI war
10. Fight for control / predation
11. Factions can be destroyed
12. Town growth
13. No cheating
14. Player joins the ecosystem
15. Chronicle / in-game narration (Polish)

The storyteller (5) and the horde (6) are one job: the horde IS the
